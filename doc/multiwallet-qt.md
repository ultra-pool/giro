...
In order to support loading of multiple wallets in giro-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is giro.cpp.
...
Changes to giro.cpp
----------------------
giro.cpp is the entry point into giro-qt, and as such, will require some minor modifications to provide hooks for
