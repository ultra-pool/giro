giro Core version 2.3.0 is now available from:

  <https://github.com/giro-project/giro/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/giro-project/giro/issues>

Compatibility
==============

giro Core is extensively tested on multiple operating systems using
...
giro Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) giro MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode giro address
...
giro Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for giro (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with giro (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/giro-project-translations/).
