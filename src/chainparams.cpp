...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0xce724ee8645d900648291622159bd486b377a2405c8f36333a0ded9f32940ebe"))
	(5, uint256("0x0000053680e1f7da839c2314f0bb8368011e333d796ecfae84b1d4c3ef8880ee"))	
        (10, uint256("0x00000ff145857a13b16821ab26dfb94d6e114acd34fa7020ea11c279df31ffb0"))
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1510967468, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51001;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // giro starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // giro: 1 day
        nTargetSpacing = 1 * 300;  // giro: 5 Mins 
        ...
        const char* pszTimestamp = "Villahermosa, Tabasco, Mexico a 23 de octubre del 2017 por Ipedrero84.";
	...
	txNew.vout[0].scriptPubKey = CScript() << ParseHex("04cbd4f8fa5ae8d6ec1cb63c71d5658b17d752e61fee7677b50e50729f7d91ee08ad4c5b304df95098797cc20cce94816c89b0f8a5bedf90429b685ca2d2b84015") << OP_CHECKSIG;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1510015830;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 705455;

  	hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xce724ee8645d900648291622159bd486b377a2405c8f36333a0ded9f32940ebe"));
	...
	vSeeds.push_back(CDNSSeedData("45.77.167.103", "45.77.167.103"));    //Miami
	vSeeds.push_back(CDNSSeedData("45.77.197.106", "45.77.197.106"));    //Miami
	vSeeds.push_back(CDNSSeedData("108.61.192.251", "108.61.192.251"));  //Atlanta
	vSeeds.push_back(CDNSSeedData("108.61.210.94", "108.61.210.94"));  //Frankfurt
	vSeeds.push_back(CDNSSeedData("45.77.61.184", "45.77.61.184"));  //Paris 
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // giro: 1 day
        nTargetSpacing = 1 * 60;  // giro: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 189); // Testnet giro addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 41);  // Testnet giro script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 219);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet giro BIP32 pubkeys 
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x61)(0x60)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet giro BIP32 prvkeys 
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // giro: 1 day
        nTargetSpacing = 1 * 60;        // giro: 1 minutes
