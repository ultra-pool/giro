...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* giro features */
        {"giro", "masternode", &masternode, true, true, false},
        {"giro", "masternodelist", &masternodelist, true, true, false},
        {"giro", "mnbudget", &mnbudget, true, true, false},
        {"giro", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"giro", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"giro", "mnsync", &mnsync, true, true, false},
        {"giro", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"giro", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use girod, or the -server option to giro-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> giro-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51002/\n";
}
