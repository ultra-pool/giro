/* src/config/giro-config.h.  Generated from giro-config.h.in by configure.  */
/* src/config/giro-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.girocoin.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "giro Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "giro Core 2.4.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "giro"
