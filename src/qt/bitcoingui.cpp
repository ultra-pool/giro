                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("giro Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a giro address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and giro: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About giro Core"), this);
    aboutAction->setStatusTip(tr("Show information about giro Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for giro"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your giro addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified giro addresses"));
    ...
    openAction->setStatusTip(tr("Open a giro: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the giro Core help message to get a list with possible giro command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("giro Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to giro network", "", count));
}
...
{
    QString strTitle = tr("giro Core"); // default title
