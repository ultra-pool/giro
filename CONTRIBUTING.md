Contributing to giro Core
============================

The giro Core project operates an open contributor model where anyone is
...
The following applies to code changes to the giro Core project, and is not to be
confused with overall giro Network Protocol consensus changes.

Whether a pull request is merged into giro Core rests with the project merge
...
Patches that change giro consensus rules are considerably more involved than
...
Where a patch set proposes to change the giro consensus, it must have been
...
The project leader is the release manager for each giro Core release.
