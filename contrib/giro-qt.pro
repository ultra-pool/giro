...
RESOURCES += src/qt/giro.qrc src/qt/giro_locale.qrc

TRANSLATIONS += src/qt/locale/giro_bg.ts \
                src/qt/locale/giro_de.ts \
                src/qt/locale/giro_en.ts \
                src/qt/locale/giro_es.ts \
                src/qt/locale/giro_fi.ts \
                src/qt/locale/giro_fr.ts \
                src/qt/locale/giro_it.ts \
                src/qt/locale/giro_ja.ts \
                src/qt/locale/giro_pl.ts \
                src/qt/locale/giro_pt.ts \
                src/qt/locale/giro_ru.ts \
                src/qt/locale/giro_sk.ts \
                src/qt/locale/giro_sv.ts \
                src/qt/locale/giro_vi.ts \
                src/qt/locale/giro_zh_CN.ts \
                src/qt/locale/giro_zh_TW.ts
